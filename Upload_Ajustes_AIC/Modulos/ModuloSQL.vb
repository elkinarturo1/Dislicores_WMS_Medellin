...
Module ModuloSQL
    ...
    Public Function sp_A_Consultar_Url_WSUNOEE(ByVal interfaz As String) As String
        ...
        Try
            ...
            urlWSUNOEE = My.Settings.Upload_Ajustes_AIC_WSUNOEE_WSUNOEE
    ...
    End Function
    Public Function sp_WMS_UPLOAD_Ajustes_AIC(ByVal transaccion As String) As DataSet
        ...
        Try
            sqlComando.Connection = sqlConexion
            sqlComando.CommandType = CommandType.StoredProcedure
            sqlComando.CommandText = "sp_WMS_UPLOAD_Ajustes_AIC"
            sqlComando.CommandTimeout = 0

            sqlComando.Parameters.AddWithValue("@transaccion", transaccion)
    ...
    Public Function sp_WMS_UPLOAD_Transferencias_TWA(ByVal transaccion As String) As DataSet
        ...
        Try
            sqlComando.Connection = sqlConexion
            sqlComando.CommandType = CommandType.StoredProcedure
            sqlComando.CommandText = "sp_WMS_UPLOAD_Transferencias_TWA"
            sqlComando.CommandTimeout = 0
    ...
    Public Sub sp_A_Log_Upload_Ajustes_AIC(ByVal bitResultado As Boolean,
        ...
        Try
            sqlComando.Connection = sqlConexion
            sqlComando.CommandType = CommandType.StoredProcedure
            sqlComando.CommandText = "sp_A_Log_Upload_Ajustes_AIC"
            sqlComando.CommandTimeout = 0
