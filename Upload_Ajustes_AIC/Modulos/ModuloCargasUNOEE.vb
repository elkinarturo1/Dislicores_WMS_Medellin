Module ModuloCargasUNOEE
    ...
    Public Sub CargasWSUNOEE(ByVal proceso As String, ByVal plano As String, ByRef objEnvio As EstructuraUploadModel)
        ...
        If My.Settings.EnviarDatosUNOEE Then
            ...
            Try
                objWSUNOEE.Url = ModuloSQL.sp_A_Consultar_Url_WSUNOEE("Upload_Ajustes_AIC")
                objWSUNOEE.Timeout = 666666
            ...
            Catch ex As Exception
                objEnvio.datosEnviadosUNOEE = strXML_UNOEE
                objEnvio.resultadoLog = CargasWSUNOEE_MetodoSuplente(proceso, strXML_UNOEE, objEnvio.bitError)
            End Try
