Public Class Upload_Comprometer_RQV_Transferir_TBV
    Private Sub Upload_Comprometer_RQV_Transferir_TBV_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Dim dsDatos As New DataSet

        Try

            If (ModuloSQL.encender_apagar_Interface("Upload_Comprometer_RQV_Transferir_TBV")) Then
                '=====================================================================================================
                ...
                Try
                    ...
                    dsDatos = ModuloSQL.sp_WMS_UPLOAD_Transferencia_TBV_Desde_RQV(numordenExpedicion, numRequisicion)
                        ...
                        Try
                            ...
                            For Each registro As DataRow In dsDatos.Tables(0).Rows
                                ...
                                Try
                                    ...
                                    objEnvio.f440_id_tipo_docto_req_int = registro.Item("f440_id_tipo_docto_req_int").ToString
