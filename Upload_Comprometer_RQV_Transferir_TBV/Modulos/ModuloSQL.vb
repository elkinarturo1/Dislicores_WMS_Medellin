...
Module ModuloSQL
    ...
    Public Function sp_A_Consultar_Url_WSUNOEE(ByVal interfaz As String) As String
        ...
        Try
            ...
            urlWSUNOEE = My.Settings.Upload_Comprometer_RQV_Transferir_TBV_WSUNOEE_WSUNOEE
    ...
    Public Function sp_WMS_UPLOAD_Transferencia_TBV_Desde_RQV(ByVal ordenExpedicion As Integer, ByVal numRequisicion As String) As DataSet
