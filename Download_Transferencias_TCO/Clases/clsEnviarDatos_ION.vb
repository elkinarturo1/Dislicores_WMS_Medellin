Public Class clsEnviarDatos_ION
    ...
    Public Sub enviar_ASN_ION_Transferencia_TCO(ByRef dt As DataTable, ByRef cia As String, ByRef co As String, ByRef tipoDoc As String, ByRef numDoc As String, ByRef rowIdEncab As String)
        ...
        Try
            ...
            For Each registro As DataRow In dt.Rows
                ...
                Try
                    ...
                    rowIdDetalle = registro.Item("d_susr1_rowid_det").ToString
                    ...
                    ModuloSQL.sp_WMS_ION_DOWNLOAD_INT_RECEIPTDETAIL(objReceiptDetail)

                Catch ex As Exception
                    ModuloSQL.sp_A_Registrar_Log_Download_Transferencias_TCO(True, objReceiptDetail.EXTERNRECEIPTKEY, cia, co, tipoDoc, numDoc, rowIdEncab, rowIdDetalle, objReceiptDetail.SKU,
            ...
            For Each registro As DataRow In dt.Rows
                ...
                Try
                    ...
                    ModuloSQL.sp_WMS_ION_DOWNLOAD_INT_RECEIPT(objReceipt)

                Catch ex As Exception
                    ModuloSQL.sp_A_Registrar_Log_Download_Transferencias_TCO(True, objReceipt.EXTERNRECEIPTKEY, cia, co, tipoDoc, numDoc, rowIdEncab,,,,,,, "Error al Enviar datos ION enviar_OEX_ION_PEV - " & ex.Message)
                End Try
