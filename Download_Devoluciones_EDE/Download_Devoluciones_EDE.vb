Public Class Download_Devoluciones_EDE

    Dim obj_Estructura_Download As New clsModeloDownloadGenerico

    Private Sub Download_Devoluciones_EDE_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            '=============================================================================================================
            ''Paso 1 Consultado Datos sp_WMS_DOWNLOAD_Devoluciones_EDE
            Try
                ds = ModuloSQL.sp_WMS_DOWNLOAD_Devoluciones_EDE()
            Catch ex As Exception
                obj_Estructura_Download.BitError = True
                ModuloSQL.sp_A_Registrar_Log_Download_ASN(True,,,,,,,,,,,,, "Error en Paso 1 Consultado Datos sp_WMS_DOWNLOAD_Transferencias_TCO2 - " & ex.Message)
            End Try
            '=============================================================================================================
            ...
            If obj_Estructura_Download.BitError = False Then
                ...
                Catch ex As Exception
                    obj_Estructura_Download.BitError = True
                    ModuloSQL.sp_A_Registrar_Log_Download_ASN(True,,,,,,,,,,,,, "Error en Paso 2 insertando datos ION - " & ex.Message)
                End Try
            End If
            '=============================================================================================================

        Catch ex As Exception
            ModuloSQL.sp_A_Registrar_Log_Download_ASN(True,,,,,,,,,,,,, "A ocurrido una Excepcion - " & ex.Message)
        End Try
                    ...
                    For Each registro As DataRow In ds.Tables(0).Rows
                        ...
                        If bitError = False Then
                            Try
                                ...
                                obj_ION.enviar_ASN_ION_EDE(dtDetalle, cia, co, tipoDoc, numDoc, rowId)
                            Catch ex As Exception
                                bitError = True
