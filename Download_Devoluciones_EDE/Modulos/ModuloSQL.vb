...
Module ModuloSQL
    ...
    Public Function sp_WMS_DOWNLOAD_Devoluciones_EDE() As DataSet
        ...
        Try
            ...
            sqlComando.CommandText = "sp_WMS_DOWNLOAD_Devoluciones_EDE"
    ...
    Public Sub sp_A_Registrar_Log_Download_Transferencias_TCO(Optional bitResultado As Boolean = False,
                                     Optional externpokey_key_docto As String = "",
                                     Optional cia As String = "",
                                     Optional co As String = "",
                                     Optional tipoDoc As String = "",
        ...
        Try
            ...
            sqlComando.Connection = sqlConexion
            sqlComando.CommandType = CommandType.StoredProcedure
            sqlComando.CommandText = "sp_A_Registrar_Log_Download_Transferencias_TCO"
            sqlComando.CommandTimeout = 0
