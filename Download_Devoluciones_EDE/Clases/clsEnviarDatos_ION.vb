Public Class clsEnviarDatos_ION
    ...
    Public Sub enviar_ASN_ION_EDE(ByRef dt As DataTable, ByRef cia As String, ByRef co As String, ByRef tipoDoc As String, ByRef numDoc As String, ByRef rowIdEncab As String)
