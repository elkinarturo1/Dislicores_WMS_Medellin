    ...
    Public Sub transferir(ByVal objEnvio As EstructuraUploadModel)
        ...
        If bitError = False Then
            ...
            Try
                ...
                strXML_GT &= "<f440_id_co_req_int>" & objEnvio.co_BodegaEntrada & "</f440_id_co_req_int>"
                ...
                strXML_GT &= "<f350_notas>" & objEnvio.ASN & "</f350_notas>"
        ...
        If bitError = False Then
            Try
                ...
                plano = ConsumoGT(110440, "TRASNFERENCIA_DESDE_REQUISICION_RQI_TBV", objEnvio.cia, dsDatosGT, resultadoConsumoGT)
