...
Public Class clsRequisiciones_x_Comprometer
    ...
    Public Sub comprometer(ByVal objEnvio As EstructuraUploadModel)
            ...
            If objEnvio.dtDetalle.Rows.Count Then
                Try
                    ...
                    For Each registro As DataRow In objEnvio.dtDetalle.Rows
                        ...
                        If IsNumeric(registro.Item("Cantidad").ToString) Then
                            ...
                            strXML_GT &= "<F_CIA>002</F_CIA>" & Environment.NewLine
                            strXML_GT &= "<f440_id_co>" & registro.Item("co_BodegaSalida").ToString & "</f440_id_co>" & Environment.NewLine
                            strXML_GT &= "<f440_id_tipo_docto>" & registro.Item("TipoDocSalida").ToString & "</f440_id_tipo_docto>" & Environment.NewLine
                            ...
                            strXML_GT &= "<f441_id_bodega>" & registro.Item("idBodegaSalida").ToString & "</f441_id_bodega>" & Environment.NewLine
                            strXML_GT &= "<f441_id_ubicación_aux>726</f441_id_ubicación_aux>" & Environment.NewLine
                            ...
                            strXML_GT &= "<f441_id_bodega_ent>" & registro.Item("idBodegaEntrada").ToString & "</f441_id_bodega_ent>" & Environment.NewLine
                            strXML_GT &= "<f441_id_ubicación_aux_ent></f441_id_ubicación_aux_ent>" & Environment.NewLine
                            strXML_GT &= "<f441_cant_base>" & registro.Item("Cantidad").ToString & "</f441_cant_base>" & Environment.NewLine
                            strXML_GT &= "<f441_cant_por_remisionar_base>" & CInt(registro.Item("Cantidad").ToString) & "</f441_cant_por_remisionar_base>" & Environment.NewLine
                            strXML_GT &= "</Compromisos>" & Environment.NewLine
                        End If
                    ...
                    '        strXML_GT &= "<f440_id_co>" & registro.Item("f350_id_co").ToString & "</f440_id_co>" & Environment.NewLine
                    '        strXML_GT &= "<f440_id_tipo_docto>RQV</f440_id_tipo_docto>" & Environment.NewLine
                    '        strXML_GT &= "<f440_consec_docto>" & registro.Item("f350_consec_docto").ToString & "</f440_consec_docto>" & Environment.NewLine
                    '        strXML_GT &= "<f441_referencia_item>" & registro.Item("SKU").ToString & "</f441_referencia_item>" & Environment.NewLine
                    ...
                    '        strXML_GT &= "<f441_nro_registro>" & CInt(registro.Item("f471_nro_registro").ToString) & "</f441_nro_registro>" & Environment.NewLine
                    '        strXML_GT &= "</Compromisos>" & Environment.NewLine
                    '    End If
        ...
        If bitError = False Then
            Try
                plano = ConsumoGT(110439, "WMS_COMPROMETER_REQUISICION_RQI", objEnvio.cia, dsDatosGT, resultadoConsumoGT)
                'plano = ConsumoGT(110437, "WMS_COMPROMETER_REQUISICION_RQV", objEnvio.cia, dsDatosGT, resultadoConsumoGT)
                'plano = ConsumoGT(110436, "WMS_REQUISICION_COMPROMISOS_RQT", objEnvio.cia, dsDatosGT, resultadoConsumoGT)
                'plano = ConsumoGT(78946, "WMS_COMPROMETER_RQV", objEnvio.cia, dsDatosGT, resultadoConsumoGT)
        ...
        Try
            ...
            ModuloSQL.sp_A_Registrar_Log_Upload_Comprometer_Transferir_RQV(objEnvio.bitError,
                                                                                       objEnvio.cia,
                                                                                       objEnvio.co,
                                                                                       objEnvio.tipoDoc,
                                                                                       objEnvio.numDoc,
