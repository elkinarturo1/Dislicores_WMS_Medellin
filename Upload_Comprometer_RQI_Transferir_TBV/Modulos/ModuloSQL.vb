...
Module ModuloSQL
    ...
    Public Function sp_A_Consultar_Url_WSUNOEE(ByVal interfaz As String) As String
        ...
        Try
            ...
            urlWSUNOEE = My.Settings.Upload_Comprometer_RQI_Transferir_TBV_WSUNOEE_WSUNOEE
    ...
    End Function
    Public Function sp_WMS_UPLOAD_Transferencia_TBV_Desde_RQI(ByVal ordenExpedicion As Integer, ByVal numRequisicion As String) As DataSet
    ...
    Public Sub sp_A_Registrar_Log_Upload_Comprometer_Transferir_RQV(ByVal bitResultado As Boolean,
        ...
        Try
            sqlComando.Connection = sqlConexion
            sqlComando.CommandType = CommandType.StoredProcedure
            sqlComando.CommandText = "sp_A_Registrar_Log_Upload_Comprometer_Transferir_RQV"
            sqlComando.CommandTimeout = 0
