Public Class Proceso_Download_Desensamble_OEX
    ...
    Public Sub ejecutarProceso_OEX()
        ...
        Try
            ...
            Try
                ds = ModuloSQL.sp_WMS_DOWNLOAD_Devoluciones_SDP_OEX()
            Catch ex As Exception
                obj_Estructura_Download.BitError = True
                ModuloSQL.A_Log_Download_OEX(True,, "2",, "SDP",,,,,,,, "Error en Paso 1 Consultado Datos sp_WMS_DOWNLOAD_Transferencias_TCO2 - " & ex.Message)
            End Try
            '=============================================================================================================
            ...
            If obj_Estructura_Download.BitError = False Then
                ...
                Catch ex As Exception
                    obj_Estructura_Download.BitError = True
                    ModuloSQL.A_Log_Download_OEX(True,, "2",, "SDP",,,,,,,, "Error en Paso 2 insertando datos ION - " & ex.Message)
                End Try
            End If
            '=============================================================================================================
                    ...
                    For Each registro As DataRow In ds.Tables(0).Rows
                        ...
                        If bitError = False Then
                            Try
                                ...
                                obj_ION.enviar_OEX_ION_SDP(dtDetalle, cia, co, tipoDoc, numDoc, rowId)
                            Catch ex As Exception
                                bitError = True
