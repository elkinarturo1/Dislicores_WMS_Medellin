...
Module ModuloSQL
    ...
    Public Function sp_WMS_DOWNLOAD_Devoluciones_SDP_Migrar() As DataSet
        ...
        Try
            ...
            sqlComando.CommandText = "sp_WMS_DOWNLOAD_Devoluciones_SDP_Migrar"
    ...
    Public Function sp_WMS_DOWNLOAD_Devoluciones_SDP_OEX() As DataSet
        ...
        Try
            ...
            sqlComando.Connection = sqlConexion
            sqlComando.CommandType = CommandType.StoredProcedure
            sqlComando.CommandText = "sp_WMS_DOWNLOAD_Devoluciones_SDP_OEX"
            sqlComando.CommandTimeout = 0
    ...
    Public Function sp_WMS_DOWNLOAD_Ensambles_ENS_ASN() As DataSet
        ...
        Try
            ...
            sqlComando.Connection = sqlConexion
            sqlComando.CommandType = CommandType.StoredProcedure
            sqlComando.CommandText = "sp_WMS_DOWNLOAD_Ensambles_ENS_ASN"
            sqlComando.CommandTimeout = 0
