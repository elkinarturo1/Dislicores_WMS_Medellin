<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="Modificar_OC_Requisiciones.aspx.vb" Inherits="Pages_Modificar_OC_Requisiciones" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div>
        ...
        <asp:Label ID="Label2" runat="server" Text="NumDocIni"></asp:Label>
        <asp:TextBox ID="txtNumDocIni" runat="server" Width="60px"></asp:TextBox>

        <asp:Label ID="Label5" runat="server" Text="NumDocFin"></asp:Label>
        <asp:TextBox ID="txtNumDocFin" runat="server" Width="60px"></asp:TextBox>
    ...
    <div>
        ...
        <asp:GridView ID="dgvDatos" runat="server" BackColor="White" BorderColor="#999999" BorderStyle="None" withe="500px"
            ...
            <Columns>
                <asp:BoundField DataField="f440_id_cia" HeaderText="f440_id_cia" ItemStyle-HorizontalAlign="Center"></asp:BoundField>
                <asp:BoundField DataField="f440_id_co" HeaderText="f440_id_co" ItemStyle-HorizontalAlign="Center"></asp:BoundField>
                <asp:BoundField DataField="f440_id_tipo_docto" HeaderText="f440_id_tipo_docto" ItemStyle-HorizontalAlign="Center"></asp:BoundField>
                <asp:BoundField DataField="f440_consec_docto" HeaderText="f440_consec_docto" ItemStyle-HorizontalAlign="Center"></asp:BoundField>
                <asp:BoundField DataField="f440_referencia" HeaderText="f440_referencia" ItemStyle-HorizontalAlign="Center"></asp:BoundField>
                <asp:BoundField DataField="f440_num_docto_referencia" HeaderText="f440_num_docto_referencia"></asp:BoundField>
                <asp:BoundField DataField="f440_id_fecha" HeaderText="f440_id_fecha"></asp:BoundField>
            </Columns>
