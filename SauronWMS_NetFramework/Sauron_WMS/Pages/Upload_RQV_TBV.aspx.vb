...
Partial Class Pages_Upload_RQV_TBV
    ...
    Protected Sub btnBuscar_Click(sender As Object, e As EventArgs) Handles btnBuscar.Click
        ...
        Try
            ...
            ds = objSQL.sp_WMS_UPLOAD_Transferencia_TBV_Desde_RQV_Migrar(bitError, resultado)
    ...
    Protected Sub btnEnviar_Click(sender As Object, e As EventArgs) Handles btnEnviar.Click
        ...
        Dim bitError As Boolean = False
        Dim resultado As String = ""
        Dim proceso As New Proceso_Upload_RQV_TBV

        Try
            proceso.ejecutarProceso(bitError, resultado, 2, "001", "RQV", txtNumDoc.Text.Trim)
        Catch ex As Exception
            bitError = False
            resultado = ex.Message
        End Try
