<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="Modificar_OC_Pedidos.aspx.vb" Inherits="Pages_Modificar_OC_Pedidos" %>
    ...
    <div>
        ...
        <asp:GridView ID="dgvDatos" runat="server" BackColor="White" BorderColor="#999999" BorderStyle="None" withe="500px"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="f430_id_fecha" HeaderText="f430_id_fecha" DataFormatString="{0:d}"></asp:BoundField>
            </Columns>
