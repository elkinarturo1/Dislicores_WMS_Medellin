...
Partial Class Pages_Upload_TCO_TCE
    ...
    Protected Sub btnBuscar_Click(sender As Object, e As EventArgs) Handles btnBuscar.Click
        ...
        Try
            ...
            ds = objSQL.sp_WMS_UPLOAD_Entrada_TCE_desde_TCO_ws_Migrar_Blazor(bitError, resultado)
    ...
    Protected Sub btnEnviar_Click(sender As Object, e As EventArgs) Handles btnEnviar.Click
        ...
        Dim bitError As Boolean = False
        Dim resultado As String = ""
        Dim proceso As New Proceso_Upload_TCO_TCE

        Try
            proceso.ejecutarProceso(bitError, resultado, 2, "001", "TCO", txtNumDoc.Text.Trim)
        Catch ex As Exception
            bitError = False
            resultado = ex.Message
        End Try
