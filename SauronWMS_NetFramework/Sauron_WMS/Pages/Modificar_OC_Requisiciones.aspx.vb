...
Partial Class Pages_Modificar_OC_Requisiciones
    Inherits System.Web.UI.Page

    Private Sub Pages_Modificar_OC_Requisiciones_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            Try
                ...
                ds = objSQL.DSP_REQUISICION_SELECT_OC("001", "PEV", 1, 999999999, fecha, fecha, "-1", "-1")
    ...
    Protected Sub btnBuscar_Click(sender As Object, e As EventArgs) Handles btnBuscar.Click
        ...
        'If Not IsNumeric(txtOcIni.Text) Then
        '    ocIni = "-1"
        'End If

        'If Not IsNumeric(txtOcFin.Text) Then
        '    ocFin = "-1"
        'End If

        ds = objSQL.DSP_REQUISICION_SELECT_OC(co, tipoDoc, numDocIni, numDocFin, fechaIni, fechaFin, ocIni, ocFin)
    ...
    Protected Sub btnEnviar_Click(sender As Object, e As EventArgs) Handles btnEnviar.Click
        ...
        If (strResultado = "") Then
            Try
                objSQL.DSP_QUITAR_PUNTOS_REQ(co, tipoDoc, numDocIni, numDocFin, fechaIni, fechaFin, ocIni, ocFin)
            Catch ex As Exception
