...
Public Class clsEnviarDatos_ION
    ...
    Public Sub enviar_OEX_ION_PEV(ByRef dt As DataTable)
        ...
        Try
            ...
            For Each registro As DataRow In dt.Rows
                ...
                Try
                    ...
                    objOrdersDetails.LOTATTRIBUTE06 = Left(registro.Item("lotattribute06_rentas").ToString, 30)

                    sp_WMS_ION_DOWNLOAD_INT_ORDERDETAIL(objOrdersDetails)

                Catch ex As Exception
                    sp_registrarLog_Download_WMS(2, 1, "pev", objOrdersDetails.EXTERNORDERKEY, "Migrando Datos Detalle : ", "Fin", "Error", "Referencia : " & objOrdersDetails.SKU & " --- Cantidad : " & objOrdersDetails.ORIGINALQTY & " - " & ex.Message)
                End Try
            ...
            For Each registro As DataRow In dt.Rows
                ...
                Catch ex As Exception
                    sp_registrarLog_Download_WMS(2, 1, "pev", objOrders.EXTERNORDERKEY, "Migrando Datos Encabezado : ", "Fin", "Error", "Referencia : " & objOrders.EXTERNORDERKEY & ex.Message)
                End Try
    ...
    Public Sub enviar_ASN_ION_OCP(ByRef dt As DataTable)
        ...
        Try
            ...
            For Each registro As DataRow In dt.Rows
                ...
                Try
                    ...
                    sp_WMS_ION_DOWNLOAD_INT_PODETAIL(objPODetail)

                Catch ex As Exception
                    sp_registrarLog_Download_WMS(2, 1, "OCP", objPODetail.EXTERNPOKEY, "Migrando Datos Detalle : ", "Fin", "Error", "Referencia : " & objPODetail.SKU & " --- Cantidad : " & objPODetail.QTYEXPECTED & " - " & ex.Message)
                End Try
            ...
            For Each registro As DataRow In dt.Rows
                ...
                Try
                    ...
                    sp_WMS_ION_DOWNLOAD_INT_PO(objPO)

                Catch ex As Exception
                    sp_registrarLog_Download_WMS(2, 1, "OCP", objPO.EXTERNPOKEY, "Migrando Datos Encabezado : ", "Fin", "Error", "Referencia : " & objPO.EXTERNPOKEY & ex.Message)
                End Try
    ...
    Public Sub enviar_ASN_ION_TCO(ByRef dt As DataTable)
        ...
        Try
            ...
            For Each registro As DataRow In dt.Rows
                ...
                Try
                    ...
                    objReceiptDetail.SUSR5 = Left(registro.Item("d_susr5_rowid_mvto").ToString, 30)
                ...
                Catch ex As Exception
                    sp_registrarLog_Download_WMS(2, 1, "TCO", objReceiptDetail.EXTERNRECEIPTKEY, "Migrando Datos Detalle : ", "Fin", "Error", "Referencia : " & objReceiptDetail.SKU & " --- Cantidad : " & objReceiptDetail.QTYEXPECTED & " - " & ex.Message)
                End Try
            ...
            For Each registro As DataRow In dt.Rows
                ...
                Catch ex As Exception
                    sp_registrarLog_Download_WMS(2, 1, "TCO", objReceipt.EXTERNRECEIPTKEY, "Migrando Datos Encabezado : ", "Fin", "Error", "Referencia : " & objReceipt.EXTERNRECEIPTKEY & ex.Message)
                End Try
    ...
    Public Sub enviar_ASN_ION_RQI(ByRef dt As DataTable)
    ...
    Public Sub enviar_ASN_ION_EDE(ByRef dt As DataTable)
        ...
        Try
            ...
            For Each registro As DataRow In dt.Rows
                ...
                Catch ex As Exception
                    sp_registrarLog_Download_WMS(2, 1, "EDE", objReceiptDetail.EXTERNRECEIPTKEY, "Migrando Datos Detalle : ", "Fin", "Error", "Referencia : " & objReceiptDetail.SKU & " --- Cantidad : " & objReceiptDetail.QTYEXPECTED & " - " & ex.Message)
                End Try
            ...
            For Each registro As DataRow In dt.Rows
                ...
                Catch ex As Exception
                    sp_registrarLog_Download_WMS(2, 1, "EDE", objReceipt.EXTERNRECEIPTKEY, "Migrando Datos Encabezado : ", "Fin", "Error", "Referencia : " & objReceipt.EXTERNRECEIPTKEY & ex.Message)
                End Try
