Public Class Upload_Ventas_Facturar_FV2
    Private Sub Upload_Ventas_Facturar_FV2_Load(sender As Object, e As EventArgs) Handles MyBase.Load

        Dim dsDatos As New DataSet

        Try

            If (ModuloSQL.encender_apagar_Interface("Facturar")) Then

                '=====================================================================================================
                'Paso 1 Captura de Datos
                Try
                    dsDatos = ModuloSQL.sp_WMS_UPLOAD_Ventas_Facturar_FV2()
                        ...
                        Try
                            ...
                            For Each registro As DataRow In dsDatos.Tables(0).Rows
                                ...
                                Try
                                    ...
                                    Dim drRelacionDoctos() As DataRow = dsDatos.Tables(1).Select("paquete = '" & Trim(objEnvio.paquete) & "'")
                                    objEnvio.dtDetalle_Relacion_Doctos = drRelacionDoctos.CopyToDataTable()

                                    Dim drCxC() As DataRow = dsDatos.Tables(2).Select("paquete = '" & Trim(objEnvio.paquete) & "'")
                                    objEnvio.dtDetalle_CxC = drCxC.CopyToDataTable()

                                    Dim AddThread1 As Threading.Thread
                                    Dim objPaquete As New clsRemisiones_x_Facturar_FV2
