...
Module ModuloSQL
    ...
    Public Function sp_A_Consultar_Url_WSUNOEE(ByVal interfaz As String) As String
        ...
        Try
            ...
            urlWSUNOEE = My.Settings.Upload_Ventas_Facturar_FV2_WSUNOEE_WSUNOEE
    ...
    Public Function sp_WMS_UPLOAD_Ventas_Facturar_FV2() As DataSet
        ...
        Try
            sqlComando.Connection = sqlConexion
            sqlComando.CommandType = CommandType.StoredProcedure
            sqlComando.CommandText = "sp_WMS_UPLOAD_Ventas_Facturar_FV2"
            sqlComando.CommandTimeout = 0
