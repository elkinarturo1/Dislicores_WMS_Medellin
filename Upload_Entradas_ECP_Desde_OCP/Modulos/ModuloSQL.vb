...
Module ModuloSQL
    ...
    Public Function sp_A_Consultar_Url_WSUNOEE(ByVal interfaz As String) As String
        ...
        Try
            ...
            urlWSUNOEE = My.Settings.Upload_Entradas_ECP_Desde_OCP_WSUNOEE_WSUNOEE
    ...
    Public Function sp_WMS_UPLOAD_Entrada_ECP_desde_OCP(ByVal ordenCompra As String, ByVal ASN As String) As DataSet
        ...
        Try
            sqlComando.Connection = sqlConexion
            sqlComando.CommandType = CommandType.StoredProcedure
            sqlComando.CommandText = "sp_WMS_UPLOAD_Entrada_ECP_desde_OCP"
            sqlComando.CommandTimeout = 0

            sqlComando.Parameters.AddWithValue("@ordenCompra", ordenCompra)
            sqlComando.Parameters.AddWithValue("@ASN", ASN)
