...
Module ModuloSQL
    ...
    Public Sub sp_A_Registrar_Log_Download_Requsiciones_RQI(Optional bitResultado As Boolean = False,
        ...
        Try
            ...
            sqlComando.Connection = sqlConexion
            sqlComando.CommandType = CommandType.StoredProcedure
            sqlComando.CommandText = "sp_A_Registrar_Log_Download_Requsiciones_RQI"
            sqlComando.CommandTimeout = 0
