Public Class Download_Requisiciones_RQI
    ...
    Private Sub Download_Requisiciones_RQI_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            '=============================================================================================================
            ''Paso 1 Consultado Datos sp_WMS_DOWNLOAD_Requisiciones_RQI
            Try
                ds = ModuloSQL.sp_WMS_DOWNLOAD_Requisiciones_RQI()
            Catch ex As Exception
                obj_Estructura_Download.BitError = True
                ModuloSQL.sp_A_Registrar_Log_Download_Requsiciones_RQI(True,,,,,,,,,,,, "Error en Paso 1 Consultado Datos sp_WMS_DOWNLOAD_Requisiciones_RQI - " & ex.Message)
            End Try
            '=============================================================================================================
            ...
            If obj_Estructura_Download.BitError = False Then
                ...
                Catch ex As Exception
                    obj_Estructura_Download.BitError = True
                    ModuloSQL.sp_A_Registrar_Log_Download_Requsiciones_RQI(True,,,,,,,,,,,, "Error en Paso 2 insertando datos ION - " & ex.Message)
                End Try
            End If
            '=============================================================================================================

        Catch ex As Exception
            ModuloSQL.sp_A_Registrar_Log_Download_Requsiciones_RQI(True,,,,,,,,,,,, "A ocurrido una Excepcion - " & ex.Message)
        End Try
    ...
    Public Sub insercion_Datos_Principales_ION(ByRef ds As DataSet)
        ...
        If ds.Tables.Count > 0 Then
            If ds.Tables(0).Rows.Count > 0 Then
                ...
                Try
                    ...
                    For Each registro As DataRow In ds.Tables(0).Rows
                        ...
                        Try
                            ...
                            numDoc = registro.Item("consecutivo").ToString
                        ...
                        Catch ex As Exception
                            bitError = True
                            ModuloSQL.sp_A_Registrar_Log_Download_Requsiciones_RQI(True, id_KEY, cia, co, tipoDoc, numDoc,,,,,, ds.GetXml(), "Error Filtrado pedido a insertar en ION - " & ex.Message)
                        End Try
                        '===================================================================================
                        ...
                        If bitError = False Then
                            ...
                            Catch ex As Exception
                                bitError = True
                                ModuloSQL.sp_A_Registrar_Log_Download_Requsiciones_RQI(True, id_KEY, cia, co, tipoDoc, numDoc,,,,,, ds.GetXml(), "Error al Limpiar registro ION - " & ex.Message)
                            End Try
                        End If
                        '===================================================================================
                        ...
                        If bitError = False Then
                            ...
                            Catch ex As Exception
                                bitError = True
                                ModuloSQL.sp_A_Registrar_Log_Download_Requsiciones_RQI(True, id_KEY, cia, co, tipoDoc, numDoc,,,,,, ds.GetXml(), "Error al Enviar datos ION enviar_OEX_ION_PEV - " & ex.Message)
                            End Try
                        End If
                        '===================================================================================
                ...
                Catch ex As Exception
                    obj_Estructura_Download.BitError = True
                    ModuloSQL.sp_A_Registrar_Log_Download_Requsiciones_RQI(True, id_KEY, cia, co, tipoDoc, numDoc, rowId,,,,,, "Error al Enviar datos ION enviar_OEX_ION_PEV - " & ex.Message)
                End Try
