...
Module ModuloSQL
    ...
    Public Function sp_A_Consultar_Url_WSUNOEE(ByVal interfaz As String) As String
        ...
        Try
            ...
            urlWSUNOEE = My.Settings.Upload_Comprometer_RQT_Transferir_TCO_TCA_WSUNOEE_WSUNOEE
    ...
    Public Function sp_WMS_UPLOAD_Transferencia_TCO_TCA_Desde_RQT(ByVal ordenExpedicion As Integer, ByVal numRequisicion As String) As DataSet
    ...
    Public Sub sp_A_Registrar_Log_Upload_Comprometer_Transferir_RQT(ByVal bitResultado As Boolean,
        ...
        Try
            sqlComando.Connection = sqlConexion
            sqlComando.CommandType = CommandType.StoredProcedure
            sqlComando.CommandText = "sp_A_Registrar_Log_Upload_Comprometer_Transferir_RQT"
            sqlComando.CommandTimeout = 0
