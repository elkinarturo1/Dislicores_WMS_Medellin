Public Class Proceso_Download_Desensamble_ASN

    Dim obj_Estructura_Download As New clsModeloDownloadGenerico
    Public Sub ejecutarProceso_ASN()
        ...
        Try
            ...
            Try
                ds = ModuloSQL.sp_WMS_DOWNLOAD_Devoluciones_DNF_ASN()
            Catch ex As Exception
                obj_Estructura_Download.BitError = True
                ModuloSQL.sp_A_Registrar_Log_Download_ASN(True,, "2",, "DNF",,,,,,,,, "Error en Paso 1 Consultado Datos sp_WMS_DOWNLOAD_Transferencias_TCO2 - " & ex.Message)
            End Try
            '=============================================================================================================
            ...
            If obj_Estructura_Download.BitError = False Then
                Try
                    insercion_Datos_Principales_ION_ASN(ds)
                Catch ex As Exception
                    obj_Estructura_Download.BitError = True
                    ModuloSQL.sp_A_Registrar_Log_Download_ASN(True,, "2",, "DNF",,,,,,,,, "Error en Paso 2 insertando datos ION - " & ex.Message)
                End Try
            End If
            '=============================================================================================================
    ...
    ''' </summary>
    Public Sub insercion_Datos_Principales_ION_ASN(ByRef ds As DataSet)
                    ...
                    For Each registro As DataRow In ds.Tables(0).Rows
                        ...
                        If bitError = False Then
                            Try
                                ...
                                obj_ION.enviar_ASN_ION_DNF(dtDetalle, cia, co, tipoDoc, numDoc, rowId)
                            Catch ex As Exception
                                bitError = True
