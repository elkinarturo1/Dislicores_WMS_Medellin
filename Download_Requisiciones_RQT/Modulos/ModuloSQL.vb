...
Module ModuloSQL
    ...
    Public Function sp_WMS_DOWNLOAD_Requisiciones_RQT() As DataSet
        ...
        Try
            ...
            sqlComando.CommandText = "sp_WMS_DOWNLOAD_Requisiciones_RQT"
    ...
    Public Sub sp_A_Registrar_Log_Download_Requsiciones_RQT(Optional bitResultado As Boolean = False,
                                     Optional EXTERNORDERKEY_key_doc As String = "",
                                     Optional cia As String = "",
                                     Optional co As String = "",
                                     Optional tipoDoc As String = "",
        ...
        Try
            ...
            sqlComando.Connection = sqlConexion
            sqlComando.CommandType = CommandType.StoredProcedure
            sqlComando.CommandText = "sp_A_Registrar_Log_Download_Requsiciones_RQT"
            sqlComando.CommandTimeout = 0
