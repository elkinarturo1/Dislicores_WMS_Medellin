Public Class Download_Requisiciones_RQT

    Dim obj_Estructura_Download As New clsModeloDownloadGenerico

    Private Sub Download_Requisiciones_RQT_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            '=============================================================================================================
            ''Paso 1 Consultado Datos sp_WMS_DOWNLOAD_Requisiciones_RQT
            Try
                ds = ModuloSQL.sp_WMS_DOWNLOAD_Requisiciones_RQT()
            Catch ex As Exception
                obj_Estructura_Download.BitError = True
                ModuloSQL.sp_A_Registrar_Log_Download_OEX(True,,,,,,,,,,,, "Error en Paso 1 Consultado Datos sp_WMS_DOWNLOAD_Requisiciones_RQT - " & ex.Message)
            End Try
            '=============================================================================================================
                    ...
                    For Each registro As DataRow In ds.Tables(0).Rows
                        ...
                        If bitError = False Then
                            Try
                                ...
                                ModuloSQL.sp_A_Registrar_Log_Download_OEX(False, id_KEY, cia, co, tipoDoc, numDoc,,,,,, ds.GetXml(), "Proceso Terminado Correctamente")
                            Catch ex As Exception
                                bitError = True
