Public Class Upload_Facturas_FV2
    Private Sub Upload_Facturas_FV2_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Try
            dsDatos = ModuloSQL.sp_WMS_UPLOAD_Facturar_FV2()
