        ...
        Try
            ...
            For Each registro As DataRow In dt.Rows
                ...
                Catch ex As Exception
                    ModuloSQL.A_Log_Download_OEX(True, objReceiptDetail.EXTERNRECEIPTKEY, cia, co, tipoDoc, numDoc, rowIdEncab, rowIdDetalle, objReceiptDetail.SKU,
            ...
            For Each registro As DataRow In dt.Rows
                ...
                Catch ex As Exception
                    ModuloSQL.A_Log_Download_OEX(True, objReceipt.EXTERNRECEIPTKEY, cia, co, tipoDoc, numDoc, rowIdEncab,,,,,, "Error al Enviar datos ION enviar_OEX_ION_PEV - " & ex.Message)
                End Try
