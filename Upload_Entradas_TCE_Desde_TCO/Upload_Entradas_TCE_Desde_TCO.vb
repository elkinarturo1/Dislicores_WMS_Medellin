Public Class Upload_Entradas_TCE_Desde_TCO
    Private Sub Upload_Entradas_TCE_Desde_TCO_Load(sender As Object, e As EventArgs) Handles MyBase.Load

        Dim dsDatos As New DataSet

        Try

            If (ModuloSQL.encender_apagar_Interface("TransferenciasTCO")) Then

                '=====================================================================================================
                'Paso 1 Captura de Datos
                Try
                    dsDatos = ModuloSQL.sp_WMS_UPLOAD_Entrada_TCE_desde_TCO()
                        ...
                        Try
                            ...
                            For Each registro As DataRow In dsDatos.Tables(0).Rows
                                ...
                                Try
                                    ...
                                    Dim objPaquete As New clsEntradas_Desde_Transferencia_TCE
