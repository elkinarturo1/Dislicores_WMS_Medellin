Public Class Upload_Notas_NV2_Desde_PDC

    Private Sub Upload_Notas_NV2_Desde_PDC_Load(sender As Object, e As EventArgs) Handles MyBase.Load

        Dim dsDatos As New DataSet


        Try
            If (ModuloSQL.encender_apagar_Interface("Upload_Notas_NV2_Desde_PDC")) Then

                '=====================================================================================================
                'Paso 1 Captura de Datos
                Try
                    dsDatos = ModuloSQL.sp_WMS_UPLOAD_Devoluciones_Notas_NV2_Desde_PDC()
                        ...
                        Try
                            ...
                            For Each registro As DataRow In dsDatos.Tables(0).Rows
                                ...
                                Try
                                    ...
                                    Dim objPaquete As New clsDevoluciones_Notas_NV2_Desde_PDC
