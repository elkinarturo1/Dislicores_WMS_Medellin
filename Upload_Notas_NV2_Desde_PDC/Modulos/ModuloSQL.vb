...
Module ModuloSQL
    ...
    Public Function sp_A_Consultar_Url_WSUNOEE(ByVal interfaz As String) As String
        ...
        Try
            ...
            urlWSUNOEE = My.Settings.Upload_Notas_NV2_Desde_PDC_WSUNOEE_WSUNOEE
    ...
    Public Function sp_WMS_UPLOAD_Devoluciones_Notas_NV2_Desde_PDC() As DataSet
        ...
        Try
            sqlComando.Connection = sqlConexion
            sqlComando.CommandType = CommandType.StoredProcedure
            sqlComando.CommandText = "sp_WMS_UPLOAD_Devoluciones_Notas_NV2_Desde_PDC"
            sqlComando.CommandTimeout = 0
    ...
    Public Function sp_WMS_UPLOAD_Entrada_TCE_desde_TCO() As DataSet
        ...
        Try
            sqlComando.Connection = sqlConexion
            sqlComando.CommandType = CommandType.StoredProcedure
            sqlComando.CommandText = "sp_WMS_UPLOAD_Entrada_TCE_desde_TCO"
            sqlComando.CommandTimeout = 0
