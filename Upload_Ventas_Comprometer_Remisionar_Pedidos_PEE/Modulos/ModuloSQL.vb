...
Module ModuloSQL
    ...
    Public Function sp_A_Consultar_Url_WSUNOEE(ByVal interfaz As String) As String
        ...
        Try
            ...
            urlWSUNOEE = My.Settings.Upload_Ventas_Comprometer_Remisionar_Pedidos_PEE_WSUNOEE_WSUNOEE
    ...
    Public Function sp_WMS_UPLOAD_Ventas_Comprometer_Remisionar_Pedidos_PEE() As DataSet
        ...
        Try
            sqlComando.Connection = sqlConexion
            sqlComando.CommandType = CommandType.StoredProcedure
            sqlComando.CommandText = "sp_WMS_UPLOAD_Ventas_Comprometer_Remisionar_Pedidos_PEE"
            sqlComando.CommandTimeout = 0
