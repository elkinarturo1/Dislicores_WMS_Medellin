...
Module ModuloSQL
    ...
    Public Function encender_apagar_Interface(ByVal interfaz As String) As Boolean
        ...
        Try
            ...
            sqlComando.CommandText = "sp_A_Consultar_Url_WSUNOEE"
    ...
    Public Function sp_A_Consultar_Url_WSUNOEE(ByVal interfaz As String) As String

        Dim sqlConexion As New SqlConnection(My.Settings.strConexionSQL)
        Dim sqlAdaptador As New SqlDataAdapter
        Dim sqlComando As SqlCommand = New SqlCommand
        Dim ds As New DataSet
        Dim urlWSUNOEE As String = ""

        Try

            urlWSUNOEE = My.Settings.Upload_Ventas_Comprometer_Remisionar_Pedidos_PEV_WSUNOEE_WSUNOEE
        ...
        If ds.Tables.Count > 0 Then
            If ds.Tables(0).Rows.Count > 0 Then
                urlWSUNOEE = ds.Tables(0).Rows(0).Item("urlWebServiceUNOEE")
            End If
        End If
    ...
    Public Function sp_WMS_UPLOAD_Ventas_Comprometer_Remisionar_Pedidos_PEV() As DataSet
        ...
        Try
            sqlComando.Connection = sqlConexion
            sqlComando.CommandType = CommandType.StoredProcedure
            sqlComando.CommandText = "sp_WMS_UPLOAD_Ventas_Comprometer_Remisionar_Pedidos_PEV"
            sqlComando.CommandTimeout = 0
    ...
    Public Sub sp_A_Registrar_Log_Upload_WSUNOEE(ByVal objLog As EstructuraUploadModel)
        ...
        Try
            sqlComando.Connection = sqlConexion
            sqlComando.CommandType = CommandType.StoredProcedure
            sqlComando.CommandText = "sp_A_Registrar_Log_Upload_WSUNOEE"
            sqlComando.CommandTimeout = 0

            sqlComando.Parameters.AddWithValue("@bitResultado", objLog.bitError)
            sqlComando.Parameters.AddWithValue("@EXTERNORDERKEY_key_doc", objLog.EXTERNORDERKEY_key_doc)
            ...
            sqlComando.Parameters.AddWithValue("@identificador", objLog.identificador)
            sqlComando.Parameters.AddWithValue("@OEX", objLog.OEX)
            sqlComando.Parameters.AddWithValue("@ASN", objLog.ASN)
