Public Class Upload_Ventas_Comprometer_Remisionar_Pedidos_PEV
    Private Sub Upload_Ventas_Comprometer_Remisionar_Pedidos_PEV_Load(sender As Object, e As EventArgs) Handles MyBase.Load

        Dim dsDatos As New DataSet

        Try
            If (ModuloSQL.encender_apagar_Interface("ComprometerPedidosPEV")) Then
                '=====================================================================================================
                'Paso 1 Captura de Datos
                Try
                    dsDatos = ModuloSQL.sp_WMS_UPLOAD_Ventas_Comprometer_Remisionar_Pedidos_PEV()
                        ...
                        Try
                            ...
                            For Each registro As DataRow In dsDatos.Tables(0).Rows
                                ...
                                Try
                                    ...
                                    objEnvio.identificador = registro.Item("paquete").ToString
                                    ...
                                    objEnvio.EXTERNORDERKEY_key_doc = registro.Item("EXTERNORDERKEY").ToString
