...
Namespace WSGT
    ...
    Partial Public Class wsGenerarPlano
        ...
        Public Sub New()
            MyBase.New
            Me.Url = Global.Upload_Ventas_Comprometer_Remisionar_Pedidos_PEV.My.MySettings.Default.Upload_Ventas_Comprometer_Remisionar_Pedidos_PEV_WSGT_wsGenerarPlano
