...
Module ModuloSQL
    ...
    Public Function sp_WMS_DOWNLOAD_Desensambles_DES_Migrar() As DataSet
        ...
        Try
            ...
            sqlComando.CommandText = "sp_WMS_DOWNLOAD_Desensambles_DES_Migrar"
    ...
    Public Function sp_WMS_DOWNLOAD_Desensambles_DES_OEX() As DataSet
        ...
        Try
            ...
            sqlComando.Connection = sqlConexion
            sqlComando.CommandType = CommandType.StoredProcedure
            sqlComando.CommandText = "sp_WMS_DOWNLOAD_Desensambles_DES_OEX"
            sqlComando.CommandTimeout = 0
    ...
    Public Function sp_WMS_DOWNLOAD_Desensambles_DES_ASN() As DataSet
        ...
        Try
            ...
            sqlComando.Connection = sqlConexion
            sqlComando.CommandType = CommandType.StoredProcedure
            sqlComando.CommandText = "sp_WMS_DOWNLOAD_Desensambles_DES_ASN"
            sqlComando.CommandTimeout = 0
