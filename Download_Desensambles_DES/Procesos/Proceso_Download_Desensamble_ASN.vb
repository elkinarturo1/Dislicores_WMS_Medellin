Public Class Proceso_Download_Desensamble_ASN
    ...
    Public Sub ejecutarProceso_ASN()
        ...
        Try
            ...
            Try
                ds = ModuloSQL.sp_WMS_DOWNLOAD_Desensambles_DES_ASN()
            Catch ex As Exception
                obj_Estructura_Download.BitError = True
                ModuloSQL.sp_A_Registrar_Log_Download_ASN(True,, "2",, "DES",,,,,,,,, "Error en Paso 1 Consultado Datos sp_WMS_DOWNLOAD_Transferencias_TCO2 - " & ex.Message)
            End Try
            '=============================================================================================================
            ...
            If obj_Estructura_Download.BitError = False Then
                ...
                Catch ex As Exception
                    obj_Estructura_Download.BitError = True
                    ModuloSQL.sp_A_Registrar_Log_Download_ASN(True,, "2",, "DES",,,,,,,,, "Error en Paso 2 insertando datos ION - " & ex.Message)
                End Try
            End If
            '=============================================================================================================
