            ...
            If ds.Tables(0).Rows.Count > 0 Then
                ...
                For Each registro As DataRow In ds.Tables(0).Rows
                    ...
                    Try
                        ...
                        strStorerKey = Left(registro.Item("storerkey_key_prov").ToString, 15)

                        objDatos.STORERKEY = strStorerKey
                        objDatos.TYPE = Left(registro.Item("type_tipo_prov").ToString, 30)
                        objDatos.COMPANY = Left(registro.Item("company_des_prov").ToString, 45)
                    ...
                    Catch ex As Exception
                        ModuloSQL.sp_WMS_DOWNLOAD_Proveedores(True, strStorerKey, objDatos.ADDRESS5, ds.GetXml(), "Se ha presentado una excepcion " & ex.Message)
                    End Try
