...
Module ModuloSQL
    ...
    Public Function sp_WMS_DOWNLOAD_Proveedores() As DataSet
        ...
        Try
            ...
            sqlComando.CommandText = "sp_WMS_DOWNLOAD_Proveedores"
    ...
    Public Sub sp_WMS_DOWNLOAD_Proveedores(Optional bitResultado As Boolean = False,
                                    Optional storerkey_key_prov As String = "",
        ...
        Try
            ...
            sqlComando.Parameters.AddWithValue("@storerkey_key_prov", storerkey_key_prov)
