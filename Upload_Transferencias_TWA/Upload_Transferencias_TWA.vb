Public Class Upload_Transferencias_TWA
    Private Sub Upload_Transferencias_TWA_Load(sender As Object, e As EventArgs) Handles MyBase.Load

        Dim dsDatos As New DataSet

        Try

            If (ModuloSQL.encender_apagar_Interface("TransferenciasTWA")) Then
                ...
                Try
                    ...
                    transaccion = "-1"
                    dsDatos = ModuloSQL.sp_WMS_UPLOAD_Transferencias_TWA(transaccion)
                        ...
                        Try
                            ...
                            For Each registro As DataRow In dsDatos.Tables(0).Rows
                                ...
                                Try
                                    ...
                                    Dim objPaquete As New clsTransferencia_TWA
