...
Module ModuloSQL
    ...
    Public Function sp_A_Consultar_Url_WSUNOEE(ByVal interfaz As String) As String
        ...
        Try
            ...
            urlWSUNOEE = My.Settings.Upload_Transferencias_TWA_WSUNOEE_WSUNOEE
    ...
    Public Sub sp_A_Registrar_Log_Upload_Transferencias_TEB(ByVal bitResultado As Boolean,
        ...
        Try
            sqlComando.Connection = sqlConexion
            sqlComando.CommandType = CommandType.StoredProcedure
            sqlComando.CommandText = "sp_A_Registrar_Log_Upload_Transferencias_TEB"
            sqlComando.CommandTimeout = 0
