...
Namespace WSGT
    ...
    Partial Public Class wsGenerarPlano
        ...
        Public Sub New()
            MyBase.New
            Me.Url = Global.Upload_Ventas_Comprometer_Remisionar_SM_Pedidos_PIN.My.MySettings.Default.Upload_Ventas_Comprometer_Remisionar_SM_Pedidos_PIN_WSGT_wsGenerarPlano
