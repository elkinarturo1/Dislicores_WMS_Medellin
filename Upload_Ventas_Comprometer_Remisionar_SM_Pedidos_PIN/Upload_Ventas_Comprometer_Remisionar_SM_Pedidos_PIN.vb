Public Class Upload_Ventas_Comprometer_Remisionar_SM_Pedidos_PIN
    Private Sub Upload_Ventas_Comprometer_Remisionar_SM_Pedidos_PIN_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Dim dsDatos As New DataSet

        Try
            If (ModuloSQL.encender_apagar_Interface("ComprometerPedidosPIN")) Then
                '=====================================================================================================
                'Paso 1 Captura de Datos
                Try
                    dsDatos = ModuloSQL.sp_WMS_UPLOAD_Ventas_Comprometer_Remisionar_SM_Pedidos_PIN()
