...
Module ModuloSQL
    ...
    Public Function sp_A_Consultar_Url_WSUNOEE(ByVal interfaz As String) As String
        ...
        Try
            ...
            urlWSUNOEE = My.Settings.Upload_Ventas_Comprometer_Remisionar_SM_Pedidos_PIN_WSUNOEE_WSUNOEE
    ...
    Public Function sp_WMS_UPLOAD_Ventas_Comprometer_Remisionar_SM_Pedidos_PIN() As DataSet
        ...
        Try
            sqlComando.Connection = sqlConexion
            sqlComando.CommandType = CommandType.StoredProcedure
            sqlComando.CommandText = "sp_WMS_UPLOAD_Ventas_Comprometer_Remisionar_SM_Pedidos_PIN"
            sqlComando.CommandTimeout = 0
    ...
    Public Sub sp_A_Registrar_Log_Upload_Comprometer_Remisionar_SM_Pedidos_PIN(ByVal bitResultado As Boolean,
        ...
        Try
            sqlComando.Connection = sqlConexion
            sqlComando.CommandType = CommandType.StoredProcedure
            sqlComando.CommandText = "sp_A_Registrar_Log_Upload_Comprometer_Remisionar_SM_Pedidos_PIN"
            sqlComando.CommandTimeout = 0
