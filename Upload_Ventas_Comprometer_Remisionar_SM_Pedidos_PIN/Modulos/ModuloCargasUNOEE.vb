Module ModuloCargasUNOEE
    ...
    Public Sub CargasWSUNOEE(ByVal proceso As String, ByVal plano As String, ByRef objEnvio As EstructuraUploadModel, ByRef bitError As Boolean)
        ...
        If My.Settings.EnviarDatosUNOEE Then
            ...
            strXML_UNOEE &= "<NombreConexion>SIESA_ATENEA</NombreConexion>" & Environment.NewLine ' Conexion del servidor ATLAS
            ...
            Try
                ...
                objWSUNOEE.Url = ModuloSQL.sp_A_Consultar_Url_WSUNOEE("ComprometerPedidosPIN")

                objWSUNOEE.Timeout = 480000
