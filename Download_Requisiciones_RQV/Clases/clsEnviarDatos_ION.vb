        ...
        Try
            ...
            For Each registro As DataRow In dt.Rows
                ...
                Catch ex As Exception
                    ModuloSQL.sp_A_Registrar_Log_Download_Requsiciones_RQV(True, objOrdersDetails.EXTERNORDERKEY, cia, co, tipoDoc, numDoc, rowIdEncab, rowIdDetalle, objOrdersDetails.SKU,
            ...
            For Each registro As DataRow In dt.Rows
                ...
                Catch ex As Exception
                    ModuloSQL.sp_A_Registrar_Log_Download_Requsiciones_RQV(True, objOrders.EXTERNORDERKEY, cia, co, tipoDoc, numDoc, rowIdEncab,,,,,, "Error al Enviar datos ION enviar_OEX_ION_PEV - " & ex.Message)
                End Try
