Public Class Download_Requisiciones_RQV

    Dim obj_Estructura_Download As New clsModeloDownloadGenerico
    Private Sub Download_Requisiciones_RQV_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            '=============================================================================================================
            ''Paso 1 Consultado Datos sp_WMS_DOWNLOAD_Requisiciones_RQV
            Try
                ds = ModuloSQL.sp_WMS_DOWNLOAD_Requisiciones_RQV()
            Catch ex As Exception
                obj_Estructura_Download.BitError = True
                ModuloSQL.sp_A_Registrar_Log_Download_OEX(True,,,,,,,,,,,, "Error en Paso 1 Consultado Datos sp_WMS_DOWNLOAD_Requisiciones_RQV - " & ex.Message)
            End Try
            '=============================================================================================================
