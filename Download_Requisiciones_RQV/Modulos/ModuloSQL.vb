...
Module ModuloSQL
    ...
    Public Function sp_WMS_DOWNLOAD_Requisiciones_RQV() As DataSet
        ...
        Try
            ...
            sqlComando.CommandText = "sp_WMS_DOWNLOAD_Requisiciones_RQV"
    ...
    Public Sub sp_A_Registrar_Log_Download_Requsiciones_RQV(Optional bitResultado As Boolean = False,
                                     Optional EXTERNORDERKEY_key_doc As String = "",
                                     Optional cia As String = "",
                                     Optional co As String = "",
                                     Optional tipoDoc As String = "",
        ...
        Try
            ...
            sqlComando.Connection = sqlConexion
            sqlComando.CommandType = CommandType.StoredProcedure
            sqlComando.CommandText = "sp_A_Registrar_Log_Download_Requsiciones_RQV"
            sqlComando.CommandTimeout = 0
