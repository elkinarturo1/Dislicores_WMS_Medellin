        ...
        Try
            ...
            For Each registro As DataRow In dt.Rows
                ...
                Catch ex As Exception
                    ModuloSQL.sp_A_Registrar_Log_Download_Requiciones_RQI(True, objReceiptDetail.EXTERNRECEIPTKEY, cia, co, tipoDoc, numDoc, rowIdEncab, rowIdDetalle, objReceiptDetail.SKU,
            ...
            For Each registro As DataRow In dt.Rows
                ...
                Catch ex As Exception
                    ModuloSQL.sp_A_Registrar_Log_Download_Requiciones_RQI(True, objReceipt.EXTERNRECEIPTKEY, cia, co, tipoDoc, numDoc, rowIdEncab,,,,,,, "Error al Enviar datos ION enviar_OEX_ION_PEV - " & ex.Message)
                End Try
